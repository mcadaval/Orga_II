...
combinar_asm:
	...
	movdqu xmm14,xmm0
	pcmpeqd xmm14,[div_int]         ; xmm14 =  1 | 1 | 1 | 1 ?
	movd r12d,xmm14                 ; r12d = 1  
	cmp r12d,1
	je .division_entera				
...
;
	...
	add r14d,1                      ;incremento la fila para la proxima iteracion
		...
		pmuldq xmm1,xmm0       ; (int) xmm1 = 0 | 0 | 0 | (A0 -An-3) * 1 | 0 | 0 | 0 | (R0 - Rn-3) * 1  | 0 | 0 | 0 | (G0 - Gn-3) * 1  | 0 | 0 | 0 | (B0 - Bn-3) *  1
		pmuldq xmm5,xmm0
		pmuldq xmm4,xmm0
		pmuldq xmm6,xmm0

		paddd xmm1,xmm10     ; (int) xmm1 = 0 | 0 | 0 | (A0 -An-3) * 1 + An-3 = (A'0) | 0 | 0 | 0 | (R0 - Rn-3) * 1 + Rn-3 = (R'0)| 0 | 0 | 0 | (G0 - Gn-3) * 1 + Gn-3 = (G'0)| 0 | 0 | 0 | (B0 - Bn-3) *  1 + Bn-3  =(B'0)
		paddd xmm5,xmm8
		paddd xmm4,xmm9
		paddd xmm6,xmm7
